...
export const COMPONENT_DEFS: ComponentDef[] = [
  ...
  },
  {
    ...
    props: [
      ...
      { key: 'dofFocus',       label: 'DOF 초점거리 (m, 이 거리가 선명)',     type: 'number', default: 8,  min: 0.5, max: 60, step: 0.5, group: 'advanced' },
      { key: 'dofFocalLength', label: 'DOF 초점범위 (m, 선명한 폭)',          type: 'number', default: 10, min: 0.5, max: 60, step: 0.5, group: 'advanced' },
      { key: 'dofBokeh',       label: 'DOF 흐림 강도',          type: 'number', default: 3,    min: 0, max: 8,    step: 0.5, group: 'advanced' },
