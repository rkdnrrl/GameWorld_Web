...
export const COMPONENT_DEFS: ComponentDef[] = [
  ...
  },
  {
    ...
    props: [
      ...
      { key: 'dofFocus',       label: 'DOF 초점 위치 (0=가까이 ~ 1=멀리)',   type: 'number', default: 0.1, min: 0, max: 1, step: 0.02, group: 'advanced' },
      { key: 'dofFocalLength', label: 'DOF 선명 범위 (클수록 넓게 선명, 작으면 전체 흐림)', type: 'number', default: 0.5, min: 0.05, max: 1, step: 0.05, group: 'advanced' },
      { key: 'dofBokeh',       label: 'DOF 흐림 강도',          type: 'number', default: 2,    min: 0, max: 6,    step: 0.5, group: 'advanced' },
